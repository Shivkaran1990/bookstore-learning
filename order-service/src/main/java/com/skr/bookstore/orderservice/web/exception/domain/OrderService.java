...
import com.skr.bookstore.orderservice.web.exception.domain.model.CreateOrderResponse;
import com.skr.bookstore.orderservice.web.exception.domain.model.OrderCreatedEvent;
import com.skr.bookstore.orderservice.web.exception.domain.model.OrderDTO;
import com.skr.bookstore.orderservice.web.exception.domain.model.OrderStatus;
...
public class OrderService {
    ...
    OrderService(OrderRepository orderRepository,OrderValidator orderValidator,OrderEventService eventService) {
        this.orderRepository = orderRepository;
        this.orderValidator=orderValidator;
        this.orderEventService=eventService;
    }
//    public List<OrderSummary> findOrders(String userName) {
//    	List<OrderEntity> orders=orderRepository.findByUserName(userName);
//        return orders.stream().map(order -> new OrderSummary(order.getOrderNumber(),order.getStatus())).toList();
//    }
    ...
    public CreateOrderResponse createOrder(String userName, CreateOrderRequest request) {
        ...
        OrderCreatedEvent createdEvent=OrderEventMapper.buildOrderCreatedEvent(savedOrder);
        orderEventService.save(createdEvent);
