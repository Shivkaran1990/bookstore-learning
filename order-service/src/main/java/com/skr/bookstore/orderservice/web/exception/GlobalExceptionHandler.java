package com.skr.bookstore.orderservice.web.exception;
...
import com.skr.bookstore.orderservice.web.exception.domain.InvalidOrderException;
import com.skr.bookstore.orderservice.web.exception.domain.OrderNotFoundException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ProblemDetail handleUnhandledExDetail(Exception e)
    {
    	ProblemDetail problemDetail=ProblemDetail.forStatusAndDetail(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
    	problemDetail.setTitle("Internal Service Error");
    	problemDetail.setType(ISE_FOUND_TYPE);
    	problemDetail.setProperty("Serivce Name ", SERVICE_NAME);
